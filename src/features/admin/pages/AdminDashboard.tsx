...
import AddTeacher from '@/features/admin/components/AddTeacher';
import AddClass from '@/features/admin/components/AddClass';
import QuickActionCarousel from '@/shared/components/QuickActionCarousel';
